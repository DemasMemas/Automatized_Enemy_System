...
devices_table = {
    1: {  # Уровень 1 (слабые противники)
        ...
        2: ["Бинокль", "Фонарь", "Набор инструментов Оружейника (Упрощёные) 5", "Плоскогубцы"],
        3: ["Рация", "КПК", "Плоскогубцы", "Набор инструментов Оружейника (Упрощёные) 5"],
        4: ["КПК", "Набор инструментов Оружейника (Упрощёные) 5", "Мультитул"]
    },
    2: {  # Уровень 2 (средние противники)
        ...
        4: ["Шприц пистолет", "Фонарь улучшенный", "КПК", "Набор инструментов Оружейника (Стандартные) 8"]
    },
    3: {  # Уровень 3 (сильные противники)
        ...
        3: ["Фонарь улучшенный", "Бинокль ночной", "КПК", "Шприц пистолет", "Набор инструментов Оружейника (Расширенные) 12"],
...
class EnemyLoot:
    ...
    def generate_loot(self):
        ...
        enemy_food.append(random.choice(food_table.get(self.level).get(self.wealth)))
        return [enemy_bullets, enemy_meds, enemy_food, enemy_devices, enemy_misc]
    ...
    def get_bullets(self):
        return random.randint(int(self.enemy.weapon[1] / 3), int(self.enemy.weapon[1]))
